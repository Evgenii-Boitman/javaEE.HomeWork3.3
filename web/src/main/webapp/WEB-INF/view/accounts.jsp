...
<sec:authorize access="hasAuthority('ADMIN')">
    ...
    <h1>${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.username}, рады Вас приветствовать!</h1>
...
<sec:authorize access="hasAuthority('USER')">
    ...
    <h4>Номер банковского аккаунта: ${account.numberAccount}</h4>
    <h4>Баланс банковского аккаунта: ${account.accountBalance}</h4>
    <h4><a href=${pageContext.request.contextPath}/account/${account.id}>Подробнее</a></h4>
