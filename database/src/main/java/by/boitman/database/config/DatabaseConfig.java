package by.boitman.database.config;
...
@ComponentScan("by.boitman.database")
@PropertySource({"classpath:datasource.properties", "classpath:hibernate.properties"})
@EnableTransactionManagement
@Configuration
@EnableJpaRepositories(basePackages = "by.boitman.database.repository")
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Properties hibernateProperties) {
        ...
        entityManagerFactory.setPackagesToScan("by.boitman.database.entity");
